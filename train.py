...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="train/test split number. One of {1, 2, 3}",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--img_dim", type=int, default=224, help="Height / width dimension"
    )
    parser.add_argument(
    ...
    train_dataloader = DataLoader(
        train_dataset, batch_size=opt.batch_size, shuffle=True, num_workers=4
    )
    ...
    test_dataloader = DataLoader(
        test_dataset, batch_size=opt.batch_size, shuffle=False, num_workers=4
    )
    ...
    for epoch in range(opt.num_epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            ...
            torch.save(
                model.state_dict(),
                f"model_checkpoints/{model.__class__.__name__}_{epoch}.pth",
            )
